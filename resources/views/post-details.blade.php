                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="post post-single">
                            ...
                            <div class="featured-image">
                                <img src="post_images/post_16/forest-simon-OLOZGO5NjpY-unsplash.jpg" alt="post-title" />
                            </div>
                            <!-- post content -->
                        ...
                        <div class="about-author padding-30 rounded">
                            <div class="thumb">
                                <img src="{{asset('assets/frontend/images/other/avatar-about.png') }}" alt="Katen Doe" />
                            </div>
                            <div class="details">
                            ...
                            <div class="comments bordered padding-30 rounded">
                                        ...
                                        <li class="comment rounded">
                                            ...
                                            <div class="details">
                                                ...
                                                <p>Ut voluptas esse sed vero repudiandae ut fugit reprehenderit. Et voluptatem alias et dolorem quasi est sint necessitatibus ut rerum accusamus! Qui ipsum minima ut architecto labore aut inventore similique! Sed quia fugiat ut eveniet voluptas</p>
                                        ...
                                        <li class="comment rounded">
                                            ...
                                            <div class="details">
                                                ...
                                                <p>Ut corrupti quia ea corporis quasi qui dolore officia a fugit veniam non quam incidunt sed saepe numquam.</p>
                                                <a href="#" data-comment-id="4" class="btn btn-default btn-sm" data-bs-toggle="modal" data-bs-target="#replyModal">Reply</a>
                                            </div>
                                        </li>
                        ...
                        <div class="sidebar">
                            ...
                            <div class="widget rounded">
                                <div class="widget-about data-bg-image text-center" data-bg-image="assets/frontend/images/map-bg.png">
                                    <img width="118" height="26" src="{{asset('assets/brand/blue.png') }}" alt="logo" class="mb-4" />

...
<body>
        ...
        <header class="header-default">
            <nav class="navbar navbar-expand-lg">
                <div class="container-xl">
                    <!-- site logo -->
                    <a class="navbar-brand" href="index.html"><img width="118" height="26" src="{{ asset('assets/brand/blue.png') }}" alt="logo" /></a>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="post post-single">
                            ...
                            <div class="post-header">
                                <h1 class="title mt-0 mb-3">Test</h1>
                            ...
                            <div class="featured-image">
                                @if(!empty($post->image))
                                    <img src='{{ asset("post_images/$post->image") }}' alt="post-image" />
                                @else
                                    <img src='{{ asset("assets/frontend/images/posts/post-md-2.jpg") }}' alt="post-image" />
                                @endif
                            </div>
                            <!-- post content -->
                        ...
                        <div class="section-header">
                            ...
                            <img src="{{ asset('assets/frontend/images/wave.svg') }}" class="wave" alt="wave" />
                        </div>
                                ...
                                <ul class="comments">
                                    ...
                                    @foreach($post->comments  as $key => $comment)
                                        ...
                                        <li class="comment rounded">
                                            ...
                                            <div class="details">
                                                <h4 class="name"><a href="#">{{ $comment->visitor_name }}</a></h4>
                                                <span class="date">{{ $comment->created_at }}</span>
                                                <p>{{ $comment->body }}</p>
                                                <a onClick="getCommentId({{ $comment->id }})" href="#" data-comment-id="3" class="btn btn-default btn-sm" data-bs-toggle="modal" data-bs-target="#replyModal">Reply</a>
                                            </div>
                                        </li>
                        ...
                        <div class="comment-form rounded bordered padding-30">
                            ...
                            <form id="comment-form" class="comment-form" method="post" action="{{ url('comment/store') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="column col-md-12">
                                        ...
                                        <div class="form-group">
                                            <textarea name="body" id="body" class="form-control" rows="4" placeholder="Your comment here..." required="required"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="column col-md-6">
                                        <!-- Email input -->
                                        <div class="form-group">
                                            <input type="email" class="form-control" name="visitor_email" placeholder="Email address" required="required">
                                        </div>
                                    </div>
                                    ...
                                    <div class="column col-md-6">
                                        <!-- Name input -->
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="visitor_name"  placeholder="Website" required="required">
                                        </div>
                                    </div>
                                    ...
                                    <div class="column col-md-12">
                                        <!-- Website input -->
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="visitor_website" id="InputName"  placeholder="Your name" required="required">
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sidebar">
                            ...
                            <div class="widget rounded">
                                <div class="widget-about data-bg-image text-center" data-bg-image="{{ asset('assets/frontend/images/map-bg.png') }}">
                                    <img width="118" height="26" src="{{ url('assets/brand/blue.png') }}" alt="logo" class="mb-4" />
                                        ...
                                        <div class="post post-list-sm circle">
                                            <div class="thumb circle">
                                                ...
                                                <a href="blog-single.html">
                                                    <div class="inner">
                                                        <img src="{{ asset('assets/frontend/images/posts/tabs-1.jpg') }}" alt="post-title" />
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="details clearfix">
                                                <h6 class="post-title my-0"><a href="blog-single.html">This is a test tile</a></h6>
    ...
    <div class="canvas-menu d-flex align-items-end flex-column">
        ...
        <!-- logo -->
        <div class="logo">
            <img width="118" height="26" src="{{ asset('assets/brand/blue.png') }}" alt="Katen" />
        </div>
    ...
    <div class="modal-dialog">
                ...
                <form id="comment-form" class="comment-form" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="column col-md-12">
                            <!-- Comment textarea -->
                            <div class="form-group">
                                <textarea name="reply_body" id="reply_body" class="form-control" rows="4" placeholder="Your comment here..." required="required"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="column col-md-6">
                            <!-- Name input -->
                            <div class="form-group">
                                <input type="text" class="form-control" name="visitor_website" id="visitor_website" placeholder="Website" required="required">
                            </div>
                        </div>
                        ...
                        <div class="column col-md-12">
                            <!-- Email input -->
                            <div class="form-group">
                                <input type="text" class="form-control" id="visitor_name" name="visitor_name" placeholder="Your name" required="required">
                            </div>
                        </div>
        ...
        <div class="modal-footer">
            ...
            <button  onClick="triggerAddReply()" type="button" class="btn  btn-default">Save changes</button>
        </div>
        </div>
    </div>
    </div>
    ...
    <script>
        ...
        function triggerAddReply(){

            var commentId = localStorage.getItem('commentId');

            
            let route = "{{ url('comment/reply/add') }}/"+commentId;

            var data = {

                    reply_body: $('#reply_body').val(),
                    visitor_email: $('#visitor_email').val(),
                    visitor_name: $('#visitor_name').val(),
                    visitor_website: $('#visitor_website').val(),
                    _token: "{{ csrf_token() }}",
